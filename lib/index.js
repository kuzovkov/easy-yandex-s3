...
class EasyYandexS3 {
    ...
    Upload(file, route) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const s3Promise = yield s3.upload(params).promise();
                if (debug)
     ...
     */
    Download(routeFullPath_1) {
        return __awaiter(this, arguments, void 0, function* (routeFullPath, destinationFullPath = false) {
            if (routeFullPath[0] === '/')
    ...
    _getAllObjects() {
        return __awaiter(this, void 0, void 0, function* () {
            let objects = [];
            const helper = (...args_1) => __awaiter(this, [...args_1], void 0, function* (token = "") {
                const { Bucket } = this;
                const { s3 } = this;
                const params = {
                    Bucket
